...
function oo0O0(mw) {
    ...
    for (var i = 0, len = window.a.length; i < len; i++) {
        window.b += String.fromCharCode(window.a[i]["charCodeAt"]() - i - 5)
    }
    ...
    let func = atob(window['b'])[J('0x0', ']dQW')](J('0x1', 'GTu!'), '\'' + mw + '\'');
    eval(func);
    return ''
}

getEncrypted = function (e) {
    var _0x2268f9 = e ? e * 1000 : Date["parse"](new Date()) + 100000000
