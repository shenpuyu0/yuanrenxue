...
window.crypto = {
    getRandomValues: function () {
        console.log("调用 getRandomValues")
    },
    randomBytes: function () {
        console.log("调用 randomBytes")
    },
};
                ...
                var l = j['MD5'] = i['extend']({
                    '_doReset': function () {
                        try {
                            ...
                            'object' === typeof document ? this['_hash'] = new h['init']([0x67452301, 0xefcdab80, 0x98badcfe, 0x10325476]) : this['_hash'] = new h['init']([0x67452002, 0xefcdab80, 0x98badcfe, 0x3025476]);
                        }
                    },
...
function getEncrypted(page) {
    let f = globalThis.encry;
    let ts = Date.now();
    let h = f['AES']['encrypt'](ts + String(page), "666yuanrenxue66", {
        'mode': f['mode']['ECB'],
        'padding': f['pad']['Pkcs7']
    });
    let j = {
