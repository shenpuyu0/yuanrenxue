...
function core(arr, array64) {
    ...
    for (let i = 0; i < arr64_1.length; i++) {
        -640428591 === safe_add(args[7], 1045769941)
        -1731929597 === bit_3(args[4], args[5], args[6])
        1922609108 === safe_add(-640428591, -1731929597)
        673087083 === safe_add(1922609108, 3045445271)
        ...
        console.debug(i, "set 4 ==> ", args.join(", "));
        args.setValue(0, safe_add(a, b));
        console.debug(i, "set 0 ==> ", args.join(", "));
    }
...
function create_array64(ts) {
    ts = ts + "";
    let newArray = ckq(ts);
    newArray[104 >> 5] = newArray[104 >> 5] | (128 << (24 - (104 % 32)));
    newArray.length = 15;
    newArray.push(104);
...
console.log((new _$a).update(_$td("1687345012169")).hex());